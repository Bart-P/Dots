...
-- TODO: are the settings atually loaded? does not seem so... because "vim" global
-- is this the right way to load up specific configs for languages post nvim 0.11 ??
-- or is there a more "native" way to do this? 
